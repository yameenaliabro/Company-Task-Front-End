...
function SettingHeader({ checkscreen }: { checkscreen: boolean }) {
    return (
        ...
        <div className=" h-[129px]  bg-mdcard ">
            {checkscreen ?
                <div className="w-[263px] h-[91px] top-[35px] left-[24px] gap-16px absolute flex justify-between flex-row" >
                    <Typography.Title level={3} className="!relative top-[22px] left-[40px] ml-[110px]">Setting</Typography.Title>
                </div> :
                <div className="w-[300px] h-[91px] top-[50px] left-[24px] gap-16px absolute flex justify-between flex-row" >
                    ...
                    <Typography.Title level={3} className="w-[230px] h-[31] ml-[110px]">Edit Profile</Typography.Title>
                </div>
            }
        </div >
