...
import SettingHeader from '../SettingHeaders/setting-profile'
const SettingCard = () => {
    ...
    return (
        //accouts
        <Card className='h-[1000px] max-w-[600px] max-h-[600px] w-[365px] bg-bgprimary flex justify-center' bordered={false} cover={<SettingHeader checkscreen={true} />}>
                        ...
                        <div>
                            <Card className='w-[358px] h-[72px] border-red-50 mt-3 flex justify-center rounded-15 p-primary'>
                                <div className='flex flex-row'>
                                    ...
                                    <div className='flex justify-between '>
                                        <Typography.Title level={3} className='font-medium text-13 leading-19 ml-3 mx-0 my-0' onClick={() => setModalVisible(true)}>LogOut</Typography.Title>
